...
var _babel_helperModuleImports = require('@babel/helper-module-imports');
	...
	return {
		pre: function pre (file) {
			...
			file.set('helperGenerator', function (name) {
				...
				return (cachedHelpers[name] = _babel_helperModuleImports.addNamed(file.path, name, HELPERS));
			});
		},
	};
}
